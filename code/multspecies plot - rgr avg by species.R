...
avgrgr_plot_LM <- avgrgr_plot_LM + ylim(-0.05,0.3)
avgrgr_plot_LM <- avgrgr_plot_LM + ylab("average RGR (day 0-10)")
avgrgr_plot_LM <- avgrgr_plot_LM + ggtitle("Lemna minor")
avgrgr_plot_LM <- avgrgr_plot_LM + theme_classic(base_size=18)
avgrgr_plot_LM <- avgrgr_plot_LM + theme(legend.position = "none") 
avgrgr_plot_LM <- avgrgr_plot_LM + geom_text(data=subset(summary_data_meanrgr, summary_data_meanrgr$species=="LM"),aes(x=treatment, y=average_RGR+se+0.015,label=label))
avgrgr_plot_LM 
...
avgrgr_plot_SP <- avgrgr_plot_SP + ylim(-0.05,0.275)
avgrgr_plot_SP <- avgrgr_plot_SP + ylab("average RGR (day 0-10)")
avgrgr_plot_SP <- avgrgr_plot_SP + ggtitle("Spirodela polyrhiza")
avgrgr_plot_SP <- avgrgr_plot_SP + theme_classic(base_size=18)
avgrgr_plot_SP <- avgrgr_plot_SP + theme(legend.position = "none") 
avgrgr_plot_SP <- avgrgr_plot_SP + geom_text(data=subset(summary_data_meanrgr, summary_data_meanrgr$species=="SP"),aes(x=treatment, y=average_RGR+se+0.015,label=label))
avgrgr_plot_SP 
...
avgrgr_plot_WB <- avgrgr_plot_WB + ylim(-0.05,0.275)
avgrgr_plot_WB <- avgrgr_plot_WB + ylab("average RGR (day 0-10)")
avgrgr_plot_WB <- avgrgr_plot_WB + ggtitle("Wolffia brasiliensis")
avgrgr_plot_WB <- avgrgr_plot_WB + theme_classic(base_size=18)
avgrgr_plot_WB <- avgrgr_plot_WB + geom_text(data=subset(summary_data_meanrgr, summary_data_meanrgr$species=="WB"),aes(x=treatment, y=average_RGR+se+0.015,label=label))
avgrgr_plot_WB 
...
Fig2alt <- arrangeGrob(avgrgr_plot_high,avgrgr_plot_low,ncol=1,nrow=2) 
Fig2alt
